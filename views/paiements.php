...
# Selection Querries
require_once('../models/select/select-paiements.php');
...
// Date automatique pour le paiement (aujourd'hui)
...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
        ...
        <div id="mainContent" class="main-content ml-64 p-6 w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl p-5 shadow-lg hover-lift">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-sm font-medium text-white text-opacity-90">Paiements payés</p>
                            <p class="text-2xl font-bold mt-1">
                                <?php 
                                    $payes = array_filter($paiements, function($paiement) {
                                        return $paiement['etat'] == 'payé';
                                    });
                                    echo count($payes);
                                ?>
                            </p>
                ...
                <div class="bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl p-5 shadow-lg hover-lift">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-2xl font-bold mt-1">
                                <?php 
                                    $en_retard = array_filter($paiements, function($paiement) {
                                        return $paiement['etat'] == 'en retard';
                                    });
                ...
                <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white rounded-xl p-5 shadow-lg hover-lift">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-sm font-medium text-white text-opacity-90">Paiements en attente</p>
                            <p class="text-2xl font-bold mt-1">
                                <?php 
                                    $en_attente = array_filter($paiements, function($paiement) {
                                        return $paiement['etat'] == 'en attente';
                                    });
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-6 hover-lift">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <select id="contratFilter" class="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="paiementTableBody" class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-purple-50 transition-colors duration-200 paiement-row" 
                                ...
                                data-contrat="<?php echo $paiement['contrat_id']; ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">
                                        Contrat #<?php echo $paiement['contrat_id']; ?>
                                    </div>
                                    <div class="text-sm text-gray-500">
                                        Loyer: <?php echo number_format($paiement['loyer_mensuel'], 2, ',', ' '); ?> €
                                    </div>
                                    <div class="text-xs text-gray-400">
                                        Paiement limite: <?php echo date('d/m/Y', strtotime($paiement['date_paiement_limite'])); ?>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">
                                        <?php echo htmlspecialchars($paiement['nom_membre'] . ' ' . $paiement['postnom_membre'] . ' ' . $paiement['prenom_membre']); ?>
                                    </div>
                                    <div class="text-sm text-gray-500">
                                        Boutique #<?php echo $paiement['boutique_id']; ?>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">
                                    ...
                                    <?php if ($paiement['montant'] != $paiement['loyer_mensuel']): ?>
                                    <div class="text-xs <?php echo $paiement['montant'] < $paiement['loyer_mensuel'] ? 'text-red-600' : 'text-green-600'; ?>">
                                        <?php echo $paiement['montant'] < $paiement['loyer_mensuel'] ? 'Déficit' : 'Excédent'; ?>: 
                                        <?php echo number_format(abs($paiement['montant'] - $paiement['loyer_mensuel']), 2, ',', ' '); ?> $
                                    </div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                                        <?php 
                                            switch($paiement['etat']) {
                                                case 'payé': echo 'badge-paye'; break;
                                                case 'en retard': echo 'badge-retard'; break;
                                                case 'en attente': echo 'badge-attente'; break;
                                            }
                                        ?>">
                                        <?php echo ucfirst($paiement['etat']); ?>
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 max-w-xs truncate">
                                        <?php echo $paiement['notes'] ?: 'Aucune note'; ?>
                                    </div>
                                </td>
                        ...
                        <form id="paiementForm" action="../models/traitement/paiement-post.php" method="POST">
                            ...
                            <div class="grid grid-cols-1 gap-6 mt-4">
                                        ...
                                        <select id="contrat_id" name="contrat_id" required
                                            ...
                                            <?php foreach ($contrats as $contrat): ?>
                                                <option value="<?php echo $contrat['id']; ?>" 
                                                        ...
                                                        data-date-paiement-limite="<?php echo $contrat['date_paiement']; ?>">
                                                    Contrat #<?php echo $contrat['id']; ?> - <?php echo number_format($contrat['loyer_mensuel'], 2, ',', ' '); ?> $ ( <?php echo $contrat['date_debut']." / ".$contrat['date_fin']; ?>)
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                        ...
                                        <select id="affectation" name="affectation" required
                                            ...
                                            <?php foreach ($affectations as $affectation): ?>
                                                <option value="<?php echo $affectation['id']; ?>">
                                                    ...
                                                    Boutique #<?php echo $affectation['boutique_id']; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Date limite paiement</label>
                                        <div class="mt-1 px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700">
                                            <span id="contrat_date_paiement_limite">-</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">État (automatique)</label>
                                        <div class="mt-1 px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700">
                                            <span id="etat_automatique" class="font-medium">Calculé automatiquement</span>
                                        </div>
                                        <p class="text-xs text-gray-500 mt-1">
                                            L'état dépend du montant payé et de la date limite
                                        </p>
                                    </div>
                                </div>
    ...
    <script>
        ...
        const contratDatePaiementLimite = document.getElementById('contrat_date_paiement_limite');
        const etatAutomatique = document.getElementById('etat_automatique');
        ...
        function setupEventListeners() {
            ...
            document.querySelectorAll('.edit-paiement').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    editPaiement(paiementId, datePaiement, contratId, affectation, montant, notes);
                });
            });
        ...
        function setupContratLoyer() {
            contratSelect.addEventListener('change', function() {
                ...
                const datePaiementLimite = selectedOption.getAttribute('data-date-paiement-limite');
                ...
                if (datePaiementLimite) {
                    contratDatePaiementLimite.textContent = formatDate(datePaiementLimite);
                } else {
                    contratDatePaiementLimite.textContent = '-';
                }
                ...
                // Recalculer l'état automatique
                calculerEtatAutomatique();
            });
        }

        // Fonction pour calculer l'état automatique
        function calculerEtatAutomatique() {
            const montant = parseFloat(montantInput.value) || 0;
            const loyerMensuel = parseFloat(loyerMensuelValue.textContent) || 0;
            const datePaiementLimite = contratDatePaiementLimite.textContent;
            const aujourdhui = new Date();
            
            let etat = 'en attente';
            let classeCss = 'text-yellow-600';
            
            if (montant >= loyerMensuel) {
                // Vérifier si la date limite est dépassée
                if (datePaiementLimite !== '-') {
                    const dateLimite = new Date(datePaiementLimite.split('/').reverse().join('-'));
                    if (aujourdhui > dateLimite) {
                        etat = 'en retard';
                        classeCss = 'text-red-600';
                    } else {
                        etat = 'payé';
                        classeCss = 'text-green-600';
                    }
                } else {
                    etat = 'payé';
                    classeCss = 'text-green-600';
                }
            } else if (montant > 0 && montant < loyerMensuel) {
                // Vérifier si la date limite est dépassée
                if (datePaiementLimite !== '-') {
                    const dateLimite = new Date(datePaiementLimite.split('/').reverse().join('-'));
                    if (aujourdhui > dateLimite) {
            ...
            etatAutomatique.textContent = etat.charAt(0).toUpperCase() + etat.slice(1);
            etatAutomatique.className = 'font-medium ' + classeCss;
        }
        ...
        function setupSearchAndFilters() {
            ...
            contratFilter.addEventListener('change', filterPaiements);
        }
        ...
        function filterPaiements() {
            ...
            const contratFilterValue = contratFilter.value;
            ...
            rows.forEach(row => {
                ...
                const contrat = row.getAttribute('data-contrat');
                
                const rowText = row.textContent.toLowerCase();
                const matchesSearch = rowText.includes(searchTerm);
                const matchesEtat = !etatFilterValue || etat === etatFilterValue;
                const matchesContrat = !contratFilterValue || contrat === contratFilterValue;
                
                if (matchesSearch && matchesEtat && matchesContrat) {
                    row.style.display = '';
                    visibleCount++;
                } else {
        ...
        function showModal() {
            ...
            // Réinitialiser l'état automatique
            etatAutomatique.textContent = 'Calculé automatiquement';
            etatAutomatique.className = 'font-medium text-gray-700';
        ...
        // Éditer un paiement
        function editPaiement(paiementId, datePaiement, contratId, affectation, montant, notes) {
            const paiement = {
                id: paiementId,
